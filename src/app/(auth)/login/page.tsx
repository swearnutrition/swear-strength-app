      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-2">
            {isRecoveryMode ? 'Set your password' : 'Welcome back'}
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900/50 backdrop-blur-xl border border-slate-200 dark:border-slate-800 rounded-2xl p-8 shadow-xl shadow-slate-200/50 dark:shadow-purple-500/5">
          <form onSubmit={isRecoveryMode ? handleSetPassword : handleLogin} className="space-y-6">
            {error && (
            ...
            >
              {loading ? (
                <span className="flex items-center justify-center gap-2">
                  ...
                  {isRecoveryMode ? 'Setting password...' : 'Signing in...'}
                </span>
              ) : (
                isRecoveryMode ? 'Set Password' : 'Sign In'
              )}
            </button>
          </form>
        </div>
