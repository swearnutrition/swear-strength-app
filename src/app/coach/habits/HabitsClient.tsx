        ...
        <div className="sticky top-16 z-30 bg-purple-600 text-white shadow-lg">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => setShowRivalryModal(true)}
                className="flex items-center gap-2 bg-amber-500 hover:bg-amber-400 px-4 py-2 rounded-lg font-medium transition-colors"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
